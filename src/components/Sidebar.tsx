...
function Sidebar(){
    ...
    return (
    <>
    <div className={`bg-gradient-to-b from-plomo to-teal-100 h-full fixed lg:static w-[80%] md:w-[40%] lg:w-full transition-all duration-300 z-20  ${showMenu ? "left-0" : "-left-full" }`}>
